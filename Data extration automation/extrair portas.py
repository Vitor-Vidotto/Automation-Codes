...
def filtrar_csv():
    ...
    try:
        ...
        colunas_desejadas = ['Name', 'Position X', 'Position Y', 'Position Z', 'Rotation', 'Largura_Porta', 'Altura_Porta', 'Largura_Janela', 'Altura_Janela', 'Peitoril_Janela']

        # Filtrando as linhas que contêm os nomes desejados na coluna 'Name'
        df_filtrado = df[df['Name'].notna() & df['Name'].str.contains('AL_Porta|AL_Janela', na=False)]
        ...
        df_filtrado['num_validos'] = df_filtrado[['Name','Position X', 'Position Y', 'Position Z', 'Rotation', 'Largura_Porta', 'Altura_Porta', 'Largura_Janela', 'Altura_Janela', 'Peitoril_Janela']].notna().sum(axis=1)
